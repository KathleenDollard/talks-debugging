...
namespace MyApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // To create a GC problem, make 300_000 and make line 20 10
        ...
        private static string Gettysburg_long 
            => string.Join('|', Enumerable.Range(0, 100).Select(x => _gettysburg));
    }
    ...
    public class B
    {
        public (string name, bool inClass) C = ("Joe", true);
    }
}
